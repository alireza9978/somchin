...
public class AppTest {
    ...
    public void clearData() {
        ...
        if (sharedPreferencesFileNames != null)
            ...
            Log.i(TAG, "clearData: not worked");
        }
    }
    ...
    public void login() {
        String email = "rahimialireza.az@gmail.com";
        String pass = "D6h6KdZH";
        clearData();

        String tagValue = "login_tab_1";
        ...
        onView(withId(R.id.login_user_name_input)).perform(clearText(), typeText(email), closeSoftKeyboard());
        onView(withId(R.id.login_password_input)).perform(clearText(), typeText(pass), closeSoftKeyboard());
